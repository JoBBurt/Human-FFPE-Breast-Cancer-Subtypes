...
output_dir <- "~/Desktop/CRUK_Storming_Cancer/Breast_FFPE/JB8-14_2rep/output/ConsensusPathDB/top20/"
...
process_and_dotplot(input_dir, output_dir, t.level = 5, q.val = 0.05, num = 20)
ggsave(filename = "conserved_up_dotplot.png", )