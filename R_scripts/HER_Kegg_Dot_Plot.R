...
# data import
df <- read.csv("data/DAVID/All_Raw/HER_0p001_KEGG_All.csv", 
               stringsAsFactors = F)
...
tiff(filename="output/Pathways/HER_KEGG_All_0p001_text.tiff", width=1200, height=600)
...
# data import
df <- read.csv("data/DAVID/SASP_Raw/HER_0p001_KEGG_SASP.csv", 
               stringsAsFactors = F)
...
tiff(filename="output/Pathways/HER_KEGG_SASP_0p001_text.tiff", width=1200, height=600)
...
# data import
df <- read.csv("data/DAVID/ECM_raw/HER2_0p001_KEGG_ECM.csv", 
               stringsAsFactors = F)
...
tiff(filename="output/Pathways/HER_KEGG_ECM_0p001_text.tiff", width=1200, height=600)
